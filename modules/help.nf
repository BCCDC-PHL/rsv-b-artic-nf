...
def printHelp() {
  log.info"""
  Usage:
    nextflow run BCCDC-PHL/rsv-b-artic-nf -profile conda --prefix [prefix] [workflow-options]

  Description:
    Turn Illumina respiratory syncyctial virus B (RSV-B) sequencing reads generated by ARTIC tiling amplification protocols into consensus sequences.
